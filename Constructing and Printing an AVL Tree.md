...
## OUTPUT
![image](https://github.com/user-attachments/assets/c5cbf5c2-f7f5-4eab-b566-15b68bcc5925)

## RESULT
Thus the Python program to construct an **AVL tree** and print the nodes of it using the appropriate packages and built-in function.
