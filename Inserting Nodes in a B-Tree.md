...
## OUTPUT
![image](https://github.com/user-attachments/assets/0986b3c2-54c1-4311-9da9-5a25d263d455)

## RESULT
Thus the Python function `def insert(self, k):` to insert the nodes in a **B-Tree**.
